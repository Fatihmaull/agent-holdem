...
### A1 · Deploy ChipVault to BNB testnet — **P0** — 1d
...
### A2 · Credit deposits without the browser — **P0** — 3d
...
### A3 · Redemption reliability and the `PayoutUncertain` runbook — **P0** — 2d
...
### A4 · Chip reconciliation script — **P1** — 2d
...
### A5 · Treasury key handling and balance alerting — **P1** — 1d
...
### B5 · Monitoring and error tracking — **P1** — 2d
...
### C1 · Graceful shutdown and restart recovery — **P0** — 3d
...
### C2 · Rate limiting and abuse control — **P1** — 3d
...
### C3 · Model provider hardening — **P1** — 2d
...
### C4 · Integration tests against a real database — **P1** — 3d
...
### C5 · Engine property tests — **P2** — 2d
...
### C6 · The multi-process question — **P2** — 1d, decision only
...
### D2 · Mobile and accessibility — **P1** — 3d
...
### D3 · Error and empty states — **P1** — 2d
...
### D4 · Brain Visualizer polish — **P1** — 2d
